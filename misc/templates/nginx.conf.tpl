...
http {
	...
	upstream main {
	server {{OPENSHIFT_INTERNAL_IP}}:15010 weight=1 fail_timeout=0.3s;
	server {{OPENSHIFT_INTERNAL_IP}}:15011 weight=1 fail_timeout=0.3s;
	server {{OPENSHIFT_INTERNAL_IP}}:15012 weight=1 fail_timeout=0.3s;
