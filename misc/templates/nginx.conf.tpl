...
http {
	...
	upstream main {
	server {{OPENSHIFT_INTERNAL_IP}}:15010 weight=1 fail_timeout=0.3;
	server {{OPENSHIFT_INTERNAL_IP}}:15011 weight=2 fail_timeout=0.3;
	server {{OPENSHIFT_INTERNAL_IP}}:15012 weight=3 fail_timeout=0.3;
