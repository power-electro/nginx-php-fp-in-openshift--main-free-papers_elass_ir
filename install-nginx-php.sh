...
cp  ${OPENSHIFT_HOMEDIR}/app-root/runtime/repo/nginx-php-fp-in-openshift--main-free-papers_elass_ir/.openshift/cron/* ${OPENSHIFT_HOMEDIR}/app-root/runtime/repo/.openshift/cron
